...
void Tr_GainCalib_noErrors_CROC(TString dir, TString filename, int channelAnalyse, double GainSet, double inAmplitude, double inAmplitudeErr, bool saveLvl1, bool saveLvl2, bool mkNewOutputFile, TString outputFileName) {
