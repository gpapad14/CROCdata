...
void Transparent_Analysis_CROC(TString dir, TString filename, int channelAnalyse, bool saveLvl1, bool saveLvl2, bool mkNewOutputFile, TString outputFileName) {
...
// Plot amplitude graph and its histogram.
	...
	if(plotHistAmpl) {
		...
		cout<<"   Sigma amplitude  = " << sigmaAmpl << " (" << 100*sigmaAmpl/meanAmpl<<"%)"<<endl; 
