...
void croc_noise_likeDSI() {
	gStyle->SetOptFit(1111);

	TString date = "20191119";
	TString filename="G63_O120_ALL_noIn_20191119_105657.txt";
	// Choose which channel data you want to see/plot/analyse.
	int channelAnalyse=3;
	TString chN = "0";
	TString chan = "Ch" + chN;
	TString dir = date+"/" ;
	//dir += chan+"/";
	TString folder = "NOISE_ALL";
	dir += folder + "/";
...
// Measure the number of measurements
	...
	int firstcut=(6 + PointsPerMeas*300);
	//firstcut=0;
	double excludeEnd = 0.;
	int N = Nraw - firstcut - excludeEnd*channels;
